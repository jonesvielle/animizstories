...
const BlogPostPage = () => {
	...
	const getBlogPost = () => {
		let config = {
			...
			url: process.env.REACT_APP_API_URL + "blogPosts/" + id,
			headers: {},
		};
		...
		<div>
			...
			<div>
				<div>
					<Row className="mt-5">
						<Col>
							<h1 className="blocked-text">{blogPost.title}</h1>
						</Col>
						<label className="text-secondary">By {blogPost.author}</label>
					</Row>
				</div>
				<div className="d-flex justify-content-center my-5">
					<Row
						className="bg-light-grey w-75 p-3"
